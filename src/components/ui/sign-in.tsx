    ...
    <div className="w-full max-w-md mx-auto">
      <div className="flex flex-col gap-6">
          ...
          <div className="animate-element animate-delay-400">
            ...
            <GlassInputWrapper>
              <div className="relative">
                <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Enter your password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" required minLength={6} />
        ...
        <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); onToggleMode?.(); }} className="text-violet-400 hover:underline transition-colors ml-1">
