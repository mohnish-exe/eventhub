                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1557804506-669a67965ba0?w=3276&h=4095&q=80"
                                alt="background"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing EventHub Management</span>
                                    ...
                                    <h1
                                        ...
                                        Modern Solutions for College Events
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Streamline your college events with our powerful management platform. Book classrooms, manage approvals, and track participation effortlessly.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link to="/classrooms">
                                            <span className="text-nowrap">Book Classroom</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=2700&h=1440&q=80"
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=2700&h=1440&q=80"
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
                    ...
                    <div className="group relative m-auto max-w-5xl px-6">
                        <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
                            <Link
                                ...
                                <span> Explore EventHub Features</span>
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex">
                                <img
                                    ...
                                    src="https://images.unsplash.com/photo-1599305445771-7f5d5f5a5b5b?w=200&h=100&q=80"
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=100&q=80"
                                    alt="Classroom Booking"
                                    height="16"
                                    width="auto"
                                />
                            </div>
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit dark:invert"
                                    src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=200&h=100&q=80"
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit dark:invert"
                                    src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=200&h=100&q=80"
                                    alt="Analytics"
                                    height="20"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit dark:invert"
                                    src="https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=200&h=100&q=80"
                                    alt="User Management"
                                    height="20"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit dark:invert"
                                    src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=200&h=100&q=80"
                                    alt="Reports"
                                    height="16"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://images.unsplash.com/photo-1551434678-e076c223a692?w=200&h=100&q=80"
                                    alt="Notifications"
                                    height="28"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=200&h=100&q=80"
                                    alt="Dashboard"
                                    height="24"
                                    width="auto"
                                />
