    ...
    return (
      ...
      >
        {Icon && iconPlacement === "left" && (
          <div className="w-0 overflow-hidden opacity-0 transition-all duration-200 group-hover:w-5 group-hover:opacity-100">
            <Icon />
          </div>
        )}
        {Icon && iconPlacement === "left" && (
          <span className="ml-0 group-hover:ml-2 transition-all duration-200">
            <Slottable>{props.children}</Slottable>
          </span>
        )}
        {!Icon && <Slottable>{props.children}</Slottable>}
